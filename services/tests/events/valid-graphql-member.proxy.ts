export const validGraphqlMemberProxy = {
  "resource": "/graphql",
  "path": "/graphql",
  "httpMethod": "POST",
  "headers": {
    ...
    "User-Agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_6) AppleWebKit/537.36 (KHTML, like Gecko) AltairGraphQLClient/4.0.4 Chrome/89.0.4389.82 Electron/12.0.1 Safari/537.36",
  ...
  "multiValueHeaders": {
    ...
    "Host": [
      "lhu5xhw0sb.execute-api.us-west-2.amazonaws.com"
    ],
    "origin": [
      "electron://altair"
    ],
    ...
    "Via": [
      "2.0 7608da25eb5aed0ce7cca5fc0587c650.cloudfront.net (CloudFront)"
    ],
    "X-Amz-Cf-Id": [
      "bRAiKwFaINduWdbhTzz6jkN-ePg3o4sxAobDMVkUqmy0szzGKoWQEg=="
    ],
    "X-Amzn-Trace-Id": [
      "Root=1-60ad42fc-24af6d633bbe9e9c3c88c947"
    ],
    "X-Forwarded-For": [
      "173.52.219.239, 64.252.183.149"
    ],
    "X-Forwarded-Port": [
      "443"
    ],
  ...
  "requestContext": {
    ...
    "authorizer": {
      "claims": {
        ...
        "sub": "36fcc915-a3d2-4bba-997d-281c46419974",
        ...
        "cognito:username": "36fcc915-a3d2-4bba-997d-281c46419974",
    ...
    "identity": {
      ...
      "userArn": null,
      "userAgent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_6) AppleWebKit/537.36 (KHTML, like Gecko) AltairGraphQLClient/4.0.4 Chrome/89.0.4389.82 Electron/12.0.1 Safari/537.36",
      "user": null
    },
